...
def default_benchmark_registry() -> dict[str, BenchmarkSpec]:
    ...
    specs = (
        ...
        BenchmarkSpec(
            ...
            state_convention="Q measure, USD money-market numeraire, backward source PDE mapped to forward tau",
            ...
            expected_order=2.0,
            tolerance_components={"discretization": 2.0e-3, "oracle": 1.0e-12, "floating_point": 1.0e-10},
        ),
        BenchmarkSpec(
